...
QT può causare stress se troppo veloce (repo crisis 2019).`,
  ...
  neutral: {
    name: "Neutrale",
    shortExplanation: "Fed mantiene policy stabile - né espansione né contrazione attiva",
    fullExplanation: `Scenario Neutrale: Fed non sta né espandendo né contraendo attivamente il bilancio.

CARATTERISTICHE:
• Balance Sheet variazioni minime (<$10B/settimana)
• Spread mercato monetario normali (3-10bps)
• Riserve bancarie stabili
• Policy Fed in hold/wait-and-see

CONTESTO: Tipico di fasi transition tra QE e QT, o quando Fed aspetta dati economici prima di muoversi.`,
    whatToWatch: "Monitora Fed minutes e discorsi: segnali verbali anticipano cambio policy. Neutrale raramente dura a lungo, mercato aspetta next move."
  }
};
